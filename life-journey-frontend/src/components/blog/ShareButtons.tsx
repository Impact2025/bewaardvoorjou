...
/**
 * Deelknoppen voor blog- en kennisbankartikelen (WhatsApp + Facebook).
 * Gedeeld tussen /blog en /kennisbank voor een consistente ervaring.
 */
export function ShareButtons({ url, title }: { url: string; title: string }) {
  const waHref = `https://api.whatsapp.com/send?text=${encodeURIComponent(
    `${title} — ${url}`
  )}`;
