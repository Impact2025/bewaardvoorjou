  ...
  return (
    <footer className="border-t border-neutral-sand bg-white py-12 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-8 border-t border-neutral-sand flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-600">
          <p>&copy; {new Date().getFullYear()} BewaardVoorJou.nl. Met liefde gemaakt in Nederland.</p>
          <div className="flex items-center gap-4">
            <a
              href="https://www.instagram.com/bewaardvoorjou/"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/bewaardvoorjou"
              target="_blank"
              rel="noopener noreferrer"
