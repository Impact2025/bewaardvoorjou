    ...
    async function init() {
      ...
      try {
        const result = await createPaymentIntent({
          ...
          message_media_type: !state.forSelf && state.messageMediaUrl ? state.messageMediaType : undefined,
          gift_reveal: !state.forSelf ? state.giftReveal : undefined,
          delivery_date: !state.forSelf && state.deliveryDate ? state.deliveryDate : undefined,
