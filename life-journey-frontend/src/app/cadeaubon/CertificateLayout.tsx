        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "2.5mm" }}>
                {packageFeatures.map((f) => (
                  <div
                    key={f}
                    style={{ display: "flex", alignItems: "flex-start", gap: "3mm" }}
                  >
                    <div
                      style={{
                        width: "4px",
                    ...
                    />
                    <span style={{ color: "#444", fontSize: "8.5pt", lineHeight: 1.5 }}>
                      {f}
                    </span>
                  </div>
                ))}
            ...
            >
              ...
              >
                Geldig voor altijd &nbsp;&middot;&nbsp; bewaardvoorjou.nl &nbsp;&middot;&nbsp; Wij bewaren wat telt
              </p>
            </div>
