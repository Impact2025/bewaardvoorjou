...
export const alt = "Levensverhaal opschrijven — AI-begeleiding in het Nederlands | BewaardVoorJou.nl";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", padding: "64px", gap: "24px" }}>
          ...
          >
            AI-begeleiding in het Nederlands. Gratis starten, op jouw tempo.
          </p>
          ...
          >
            {["Gratis starten", "Geen schrijfervaring nodig", "100% AVG-veilig"].map((item) => (
              <div
                key={item}
                style={{
                  display: "flex",
