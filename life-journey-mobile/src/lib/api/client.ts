...
/**
 * Enhanced API client for React Native with error handling and retry logic
 * Adapted from web app's API client
 */
export async function apiFetch<T>(
  ...
  while (attempt <= retries) {
    try {
      ...
      // Only set Content-Type if not FormData (multipart boundary is set automatically)
